...
def create_multi_cube_observable(
    ...
    """
    Create AbstractObservables for multiple cubes (one observable per cube).
...
def generate_two_cube_circuit(
    ...
    # If measure_shared_data_final_only, only measure shared data in the meas layer
    ...
    zxz_init = create_zxz_plaquettes(translator, reset="z", use_custom_coupling=True, measure_coupling_aux=measure_zxz_coupling_aux, measure_shared_data=measure_shared_init_bulk)
    zxz_bulk = create_zxz_plaquettes(translator, use_custom_coupling=True, measure_coupling_aux=measure_zxz_coupling_aux, measure_shared_data=measure_shared_init_bulk)
    zxz_meas = create_zxz_plaquettes(translator, measurement="z", use_custom_coupling=True, measure_coupling_aux=measure_zxz_coupling_aux, measure_shared_data=measure_shared_meas)
    
    # Create plaquettes for XZX cube at (1, 0) - stores X
    xzx_init = create_xzx_plaquettes(translator, reset="x", use_custom_coupling=True, measure_coupling_aux=measure_xzx_coupling_aux)
    xzx_bulk = create_xzx_plaquettes(translator, use_custom_coupling=True, measure_coupling_aux=measure_xzx_coupling_aux)
    xzx_meas = create_xzx_plaquettes(translator, measurement="x", use_custom_coupling=True, measure_coupling_aux=measure_xzx_coupling_aux)
...
def main():
    ...
    measure_zxz_coupling_aux=True, measure_xzx_coupling_aux=True, measure_shared_data=True)
    two_cube_circuit = two_cube_circuit + two_cube_circuit.missing_detectors()
    ...
    print('num detectors single-cube: ', single_cube_circuit.num_detectors)
    print('num detectors two-cube: ', two_cube_circuit.num_detectors)
