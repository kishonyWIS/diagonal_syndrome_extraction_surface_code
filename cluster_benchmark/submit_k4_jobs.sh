#!/bin/bash
# Submit benchmark jobs for k=4 only
...
DECODERS=("tesseract")
K_VALUES=(4)
NOISE_VALUES=(0.01 0.005623413251903491 0.0031622776601683794 0.0017782794100389228 0.001 0.0005623413251903491 0.00031622776601683794)
FLAG_CONFIGS=("none" "partial" "all")
DIRECTIONS=("y")

TOTAL_JOBS=$((${#DECODERS[@]} * ${#K_VALUES[@]} * ${#NOISE_VALUES[@]} * ${#FLAG_CONFIGS[@]} * ${#DIRECTIONS[@]}))

echo "Submitting $TOTAL_JOBS jobs for k=4..."
...
echo ""
echo "All $TOTAL_JOBS k=4 jobs submitted!"
